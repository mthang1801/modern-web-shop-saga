...
import {ForgotDoneContainer, CheckIconContainer,TextContent,ButtonDone} from "./forgot-password-done.styles";
...
const ForgotPasswordDone = ({history, location, match}) => {    
  return (
    <ForgotDoneContainer>
      <CheckIconContainer><FaRegCheckCircle/></CheckIconContainer>
      <TextContent>
      ...
      <ButtonDone onClick={() => history.replace("/auth/signin")}>Done</ButtonDone>
    </ForgotDoneContainer>
  )
  }
